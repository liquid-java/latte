...
public class RefinementsLanguageParser extends Parser {
	...
	public static class StartPredContext extends StartContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof RefinementsLanguageListener ) ((RefinementsLanguageListener)listener).enterStartPred(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof RefinementsLanguageListener ) ((RefinementsLanguageListener)listener).exitStartPred(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof RefinementsLanguageVisitor ) return ((RefinementsLanguageVisitor<? extends T>)visitor).visitStartPred(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class OpMinusContext extends OperandContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof RefinementsLanguageListener ) ((RefinementsLanguageListener)listener).enterOpMinus(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof RefinementsLanguageListener ) ((RefinementsLanguageListener)listener).exitOpMinus(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof RefinementsLanguageVisitor ) return ((RefinementsLanguageVisitor<? extends T>)visitor).visitOpMinus(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	...
	public static class LiteralContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof RefinementsLanguageListener ) ((RefinementsLanguageListener)listener).enterLiteral(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof RefinementsLanguageListener ) ((RefinementsLanguageListener)listener).exitLiteral(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof RefinementsLanguageVisitor ) return ((RefinementsLanguageVisitor<? extends T>)visitor).visitLiteral(this);
			else return visitor.visitChildren(this);
		}
	}
